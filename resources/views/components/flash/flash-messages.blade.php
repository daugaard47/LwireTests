<div>
    @if ($message = Session::get('success'))
        <div x-data="{ isOpen: true }">
            <div x-show="isOpen; setTimeout(() => isOpen = false, 10000)"
                 class="px-4 alert z99 absolute pin-c lg:w-1/2 w-full">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-4">
                                <div class="-mx-2 -my-1.5 flex">
                                    <button x-on:click="isOpen = false;" type="button" data-dismiss="alert"
                                            aria-label="Dismiss"
                ...
                <div class="rounded-md bg-green-100 p-4 shadow-md">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-4">
                                <div class="-mx-2 -my-1.5 flex">
                                    <button x-on:click="isOpen = false;" data-dismiss="alert" aria-label="Dismiss"
                                            class="px-2 py-1.5 rounded text-sm leading-5 font-medium text-green-900 bg-green-200 hover:bg-green-300 focus:outline-none focus:bg-green-200 transition ease-in-out duration-150">
                                        Dismiss
                                    </button>
                                </div>
